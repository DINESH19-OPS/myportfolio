import { Mesh, Program, Renderer, Triangle, Vec3 } from 'https://unpkg.com/ogl';
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const handleMouseMove = e => {
    // Because it's a background, we track globally instead of relative to container bounds only
    const x = e.clientX;
    const y = e.clientY;
